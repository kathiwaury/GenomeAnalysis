...
#SBATCH -n 2
#SBATCH -t 08:00:00
#SBATCH -J 190513_bwa_KW_SRR4342129
...
bwa mem -P -t 2 ~/results/metabat_SRR4342129/bin_SRR4342129-2.fa ~/data/primary/RNA_trimmed/SRR4342137_trimmed_1P.fq.gz ~/data/primary/RNA_trimmed/SRR4342137_trimmed_2P.fq.gz > bin_SRR4342129-2_mapped.sam

#bwa index ~/results/metabat_SRR4342129/bin_SRR4342129-3.fa
bwa mem -P -t 2 ~/results/metabat_SRR4342129/bin_SRR4342129-3.fa ~/data/primary/RNA_trimmed/SRR4342137_trimmed_1P.fq.gz ~/data/primary/RNA_trimmed/SRR4342137_trimmed_2P.fq.gz > bin_SRR4342129-3_mapped.sam

#bwa index ~/results/metabat_SRR4342129/bin_SRR4342129-4.fa
bwa mem -P -t 2 ~/results/metabat_SRR4342129/bin_SRR4342129-4.fa ~/data/primary/RNA_trimmed/SRR4342137_trimmed_1P.fq.gz ~/data/primary/RNA_trimmed/SRR4342137_trimmed_2P.fq.gz > bin_SRR4342129-4_mapped.sam

#bwa index ~/results/metabat_SRR4342129/bin_SRR4342129-5.fa
bwa mem -P -t 2 ~/results/metabat_SRR4342129/bin_SRR4342129-5.fa ~/data/primary/RNA_trimmed/SRR4342137_trimmed_1P.fq.gz ~/data/primary/RNA_trimmed/SRR4342137_trimmed_2P.fq.gz > bin_SRR4342129-5_mapped.sam

#bwa index ~/results/metabat_SRR4342129/bin_SRR4342129-6.fa
bwa mem -P -t 2 ~/results/metabat_SRR4342129/bin_SRR4342129-6.fa ~/data/primary/RNA_trimmed/SRR4342137_trimmed_1P.fq.gz ~/data/primary/RNA_trimmed/SRR4342137_trimmed_2P.fq.gz > bin_SRR4342129-6_mapped.sam

#bwa index ~/results/metabat_SRR4342129/bin_SRR4342129-7.fa
bwa mem -P -t 2 ~/results/metabat_SRR4342129/bin_SRR4342129-7.fa ~/data/primary/RNA_trimmed/SRR4342137_trimmed_1P.fq.gz ~/data/primary/RNA_trimmed/SRR4342137_trimmed_2P.fq.gz > bin_SRR4342129-7_mapped.sam

#bwa index ~/results/metabat_SRR4342129/bin_SRR4342129-8.fa
bwa mem -P -t 2 ~/results/metabat_SRR4342129/bin_SRR4342129-8.fa ~/data/primary/RNA_trimmed/SRR4342137_trimmed_1P.fq.gz ~/data/primary/RNA_trimmed/SRR4342137_trimmed_2P.fq.gz > bin_SRR4342129-8_mapped.sam
